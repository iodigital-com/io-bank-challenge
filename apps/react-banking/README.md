# iO Bank - React Edition

A personal banking transaction manager built with React 19, Next.js, and TypeScript.
...
- **Next.js 16** - App Router for modern React applications
